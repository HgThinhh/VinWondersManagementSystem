...
{
    public partial class GUI_QuanLyVe : UserControl
    {
        public GUI_QuanLyVe()
        {
            InitializeComponent();
        ...
        private void GUI_QuanLyVe_Load(object sender, EventArgs e)
        {
            OpenChildUserControl(typeof(QuanLyVe.GUI_HoaDonVe));
            btnHoaDonVe.Checked = true;
        }
        ...
        {
            OpenChildUserControl(typeof(QuanLyVe.GUI_LoaiVe));
        }

        private void btnLichSuHoaDon_Click(object sender, EventArgs e)
        {
            OpenChildUserControl(typeof(QuanLyVe.GUI_LichSuHoaDon));
        }
    }
}
